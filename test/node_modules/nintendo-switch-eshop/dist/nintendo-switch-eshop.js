 ...
 */
exports.getGamesAmerica = (options = {}, offset = 0, games = []) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const allGamesPromises = Object.entries(categoryCount).map(([category, count]) => __awaiter(void 0, void 0, void 0, function* () {
            const normalRequest = [{
                    indexName: 'noa_aem_game_en_us',
                    params: querystring_1.stringify({
 ...
 */
exports.getGamesEurope = (options = { limit: constants.EU_GAME_LIST_LIMIT, locale: constants.EU_DEFAULT_LOCALE }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!options.limit)
 ...
 */
exports.getShopsByCountryCodes = (countryCodes, gameCode, region) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 * @returns A list of shop objects with country code, name and default currency.
 */
exports.getShopsAmerica = () => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @returns A list of shop objects with country code, name and default currency.
 */
exports.getShopsAsia = () => __awaiter(void 0, void 0, void 0, function* () {
