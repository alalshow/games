 ...
 * @returns Promise containing all the games
 */
export declare const getGamesJapan: () => Promise<interfaces.GameJP[]>;
/**
 ...
 */
export declare const getGamesEurope: (options?: interfaces.EURequestOptions) => Promise<interfaces.GameEU[]>;
/**
 ...
 */
export declare const getPrices: (country: string, gameIds: string | string[], offset?: number, prices?: interfaces.TitleData[]) => Promise<interfaces.PriceResponse>;
/**
 ...
 */
export declare const getShopsByCountryCodes: (countryCodes: string[], gameCode: string, region: interfaces.Region) => Promise<interfaces.EShop[]>;
/**
 ...
 * @returns A list of shop objects with country code, name and default currency.
 */
export declare const getShopsAmerica: () => Promise<interfaces.EShop[]>;
/**
 ...
 * @returns A list of shop objects with country code, name and default currency.
 */
export declare const getShopsEurope: () => Promise<interfaces.EShop[]>;
/**
 ...
 * @returns A list of shop objects with country code, name and default currency.
 */
export declare const getShopsAsia: () => Promise<interfaces.EShop[]>;
/**
 ...
 * @returns A list of shop objects with country code, name and default currency.
 */
export declare const getActiveShops: () => Promise<interfaces.EShop[]>;
/**
